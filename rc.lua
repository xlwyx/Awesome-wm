...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "p", awesome.shutdown,
              {description = "shutdown awesome", group = "awesome"}),
    ...
    awful.util.spawn("waterfox-g3") end,
              {description = "Waterfox", group = "applications"}),
...
awful.spawn.with_shell("feh --bg-fill ~/Pictures/Wallpaper/looplinux-v2/86.jpg")
